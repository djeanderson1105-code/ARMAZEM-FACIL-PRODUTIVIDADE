...
import { Truck, Clock, Calendar, Check, Save, RefreshCw, AlertCircle, FileSpreadsheet, MapPin, AlertTriangle, BarChart3, Plus, MessageSquare, ArrowUpCircle, ArrowDownCircle, ChevronDown } from 'lucide-react';
        ...
        <div className="bg-white border border-slate-200/60 rounded-xl p-3 shadow-3xs flex items-center gap-4">
          <div className="flex flex-col gap-1 min-w-[180px]">
            ...
            <div className="relative flex items-center">
              <Calendar className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-blue-600 font-bold" />
              <select
                value={selectedDate}
            ...
            return (
              <div className="space-y-6">
                ...
                <div className="h-8 rounded-xl overflow-hidden flex shadow-3xs border border-slate-100">
                  ...
                  {pendingPct > 0 && (
                    <div 
                      className="bg-slate-300 h-full flex items-center justify-center text-slate-700 text-[10px] font-bold transition-all"
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div className="p-3 bg-slate-50 rounded-xl border border-slate-150">
                    ...
                    <span className="text-xl font-bold font-sans text-slate-700 block mt-1">{pending}</span>
