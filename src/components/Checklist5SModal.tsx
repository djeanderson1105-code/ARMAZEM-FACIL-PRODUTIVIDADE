...
export const MAPEAMENTO_RESPONSAVEIS_5S: Responsavel5SItem[] = [
  ...
  { id: 6, area: 'PNC', colaborador: 'GLADSON LISBOA DOS SANTOS', cargo: 'CONFERENTE' },
  { id: 7, area: 'RECICLÁVEIS', colaborador: 'DEJEAN SILVA DE OLIVEIRA', cargo: 'AJUDANTE' },
  { id: 8, area: 'REFUGO', colaborador: 'GLADSON LISBOA DOS SANTOS', cargo: 'CONFERENTE' },
  { id: 9, area: 'DEVOLUÇÃO', colaborador: 'GLADSON LISBOA DOS SANTOS', cargo: 'CONFERENTE' },
