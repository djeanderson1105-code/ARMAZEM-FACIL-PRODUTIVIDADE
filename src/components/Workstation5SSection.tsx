...
export const DEFAULT_RESPONSAVEIS_5S: AreaResponsavel5S[] = [
  ...
  { id: '6', area: 'PNC', responsavel: 'GLADSON LISBOA DOS SANTOS', cargoResponsavel: 'CONFERENTE', observacao: 'Produtos Não Conformes', metaPct: 80 },
  ...
  { id: '8', area: 'REFUGO', responsavel: 'GLADSON LISBOA DOS SANTOS', cargoResponsavel: 'CONFERENTE', observacao: 'Gestão de Refugos', metaPct: 80 },
  { id: '9', area: 'DEVOLUÇÃO', responsavel: 'GLADSON LISBOA DOS SANTOS', cargoResponsavel: 'CONFERENTE', observacao: 'Conferência de Devolução', metaPct: 80 },
